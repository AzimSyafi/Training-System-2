...
# Expose the WSGI application object for PythonAnywhere / other WSGI servers
application = app
...
# WSGI snippet (paste into your PythonAnywhere WSGI file)
# Replace `<username>` with your actual PythonAnywhere username
"""
import sys
path = '/home/Azimsyafi/mysite'
if path not in sys.path:
    sys.path.insert(0, path)

# PythonAnywhere will look for a variable named `application` by default.
